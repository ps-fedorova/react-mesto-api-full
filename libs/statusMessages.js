module.exports = {
  ...
  CLIENT_ERROR: {
    UNAUTHORIZED: 'Пользователь с таким email уже зарегистрирован', // 401 Unauthorized («не авторизован (не представился)»)
    INVALID_URL_OR_PASSWORD: 'Неправильные почта или пароль', // 401 Unauthorized («не авторизован (не представился)»)
